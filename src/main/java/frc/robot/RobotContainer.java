...
public class RobotContainer {
    ...
    public RobotContainer() {
        ...
        NamedCommands.registerCommand("Target Speed", new InstantCommand(
                () -> m_Shoota.setShooterVelocity(FiringSolutionsV3.convertToRPM(m_Shoota.getCalculatedVelocity()))));
    ...
    private void configureButtonBindings() {
        ...
        primeShooterSpeedSpeaker
                .whileTrue(new InstantCommand(() -> m_Shoota
        ...
        // Zero wrist
        zeroShooter.onTrue(new InstantCommand(() -> m_Shoota.resetWristEncoders(Constants.Shooter.angleOffsetManual))); // Set
                                                                                                                        // encoder
                                                                                                                        // to
                                                                                                                        // zero
        autoZeroShooter
        ...
        // Reset R
        resetR.onTrue(new InstantCommand(() -> FiringSolutionsV3.resetAllR())); // Reset the R calculation incase it
                                                                                // gets off
         ...
         * ;
         * quasistaticForward.whileTrue(m_SwerveSubsystem.sysIdQuasistatic(Direction.
         * kForward));
         * quasistaticBackwards.whileTrue(m_SwerveSubsystem.sysIdQuasistatic(Direction.
         * kReverse));
         */
    }
